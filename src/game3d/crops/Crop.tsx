...
const CROP_COLORS: Record<string, number[]> = {
  ...
  rice: [0x7B8B3A, 0x6B7B2A, 0x5A6B1A, 0x4A5B0E, 0x5A7B1E, 0x6B8B2E, 0xD4E157],
  cotton: [0x8B8B8B, 0x7A7A7A, 0x6A6A6A, 0x5A5A5A, 0x7A7A7A, 0x9A9A9A, 0xF5F5F5],
  potato: [0x6B5B4E, 0x5A4A3E, 0x4A3A2E, 0x3A2A1E, 0x4A3A2E, 0x6B5B4E, 0xA1887F],
  strawberry: [0x5A7A2E, 0x4A6A1E, 0x3A5A0E, 0x3A6A1E, 0x4A7A2E, 0x5A8A3C, 0xFF2222],
  sugarcane: [0x6B8E23, 0x5A7E1E, 0x4A6E18, 0x3A5E12, 0x5A7E28, 0x6B8E38, 0x66BB6A],
};
